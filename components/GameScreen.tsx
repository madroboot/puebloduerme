...
import { Player, GamePhase, Role, PlayerStatus, ChatMessage } from '../types.ts';
import PlayerCircle from './PlayerCircle.tsx';
import CentralInfoPanel from './CentralInfoPanel.tsx';
import { EyeOpenIcon, EyeClosedIcon } from './icons.tsx';
